...
const (
	SchemaVersion = "context-build-artifact/local-context-control/v2"
	...
	CorpusSeed         = "local-control-corpus-v2:2026-09-23"
	ConditionOrderSeed = "local-control-condition-order-v2:2026-09-23"
	ArmOrderSeed       = "local-control-arm-order-v2:2026-09-23"
...
type Protocol struct {
	...
	ProspectiveBasis               string            `json:"prospective_basis"`
	FramingContract                string            `json:"framing_contract"`
